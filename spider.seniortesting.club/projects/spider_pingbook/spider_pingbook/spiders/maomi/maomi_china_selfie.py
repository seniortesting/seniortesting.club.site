...
class MaomiChinaSelfieSpider(scrapy.Spider):
    '''
     爬取国产精品页视频
    '''
    name = 'maomi_china_selfie'
    allowed_domains = ['maomiav.com']
    start_urls = ['https://maomiav.com/xiazai/list-%E5%9B%BD%E4%BA%A7%E8%87%AA%E6%8B%8D.html']
    base_url = 'https://maomiav.com'
    latest_page = 5  # 爬取前几页数据
    pageNo = 1
    # 用到的xpath变量
    XPATH_LIST_ITEM = "//div[@id='tpl-img-content']/li"
    XPATH_IMG = "a/@href"
    XPATH_IMG_SRC = "a/img/@src"
    XPATH_IMG_TITLE = "a/h3/text()"
    XPATH_NEXT_PAGE = "//div[@class='pagination']/a[10]/@href"

    XPATH_DETAIL_TITLE = "//h2[@class='c_pink text-ellipsis']/text()"
    XPATH_DETAIL_CATEGORY = "//*[@id=\"shipin-detail-content-pull\"]/div[2]/div[2]/p/text()"
    XPATH_DETAIL_DATE = "//*[@id=\"shipin-detail-content-pull\"]/div[2]/div[3]/p/text()"
    ...
    def parse(self, response: Response):
        ...
        for sub_item in sub_items:
            ...
            if url_selector:
                ...
                # 获取id
                searchPattern = re.search(r"^/xiazai/(.*).html$", shortUrl)
                if searchPattern:
    ...
    def parse_detail(self, response: Response):
        ...
        dateContent = response.xpath(self.XPATH_DETAIL_DATE).extract_first()
