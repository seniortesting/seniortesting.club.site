...
class MaomiShortVideoSpider(scrapy.Spider):
    '''
     描述: 爬取小视频页面
     更新历史:
     2020/07/29: 更新页面相关的xpath路径
    '''
    name = 'maomi_shortvideo'
    allowed_domains = ['maomiav.com']
    start_urls = ['https://maomiav.com/shipin/list-%e7%9f%ad%e8%a7%86%e9%a2%91.html']
    ...
    XPATH_IMG = "a/@href"
    XPATH_IMG_SRC = "a/img/@data-original"
    ...
    def parse_detail(self, response: Response):
        ...
        if len == count:
            ...
            if next_page_url and self.pageNo < self.latest_page:
                ...
                logger.info('准备爬取下一页:{}数据'.format(next_page_url))
